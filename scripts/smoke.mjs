...
await page.mouse.click(1380, 380);
await page.waitForTimeout(100);
await page.screenshot({ path: screenshotPath("cat-game-study-quick-start.png") });
await page.mouse.click(65, 55);
await page.waitForTimeout(100);
await page.mouse.click(701, 781);
await page.mouse.click(899, 781);
await page.setViewportSize({ width: 1024, height: 640 });
await page.waitForTimeout(100);
await page.screenshot({ path: screenshotPath("cat-game-study-compact.png") });
await page.setViewportSize({ width: 1600, height: 900 });
await page.waitForTimeout(100);
await page.mouse.click(1197, 697);
await page.waitForTimeout(100);
await page.screenshot({ path: screenshotPath("cat-game-study-machine-learning.png") });
await page.mouse.click(680, 385);
await page.waitForTimeout(100);
await page.screenshot({ path: screenshotPath("cat-game-study-machine-learning-task.png") });
await page.mouse.click(800, 500);
await page.waitForTimeout(150);
await page.screenshot({ path: screenshotPath("cat-game-study-machine-learning-feedback.png") });
await page.mouse.click(800, 510);
await page.waitForTimeout(100);
await page.mouse.click(65, 55);
await page.mouse.click(950, 697);
await page.waitForTimeout(100);
await page.screenshot({ path: screenshotPath("cat-game-study-sql.png") });
await page.mouse.click(943, 838);
await page.waitForTimeout(100);
await page.screenshot({ path: screenshotPath("cat-game-study-sql-page-2.png") });
await page.mouse.click(657, 838);
await page.waitForTimeout(100);
await page.mouse.click(680, 385);
await page.waitForTimeout(100);
await page.screenshot({ path: screenshotPath("cat-game-study-sql-task.png") });
await page.mouse.click(800, 500);
await page.waitForTimeout(150);
await page.screenshot({ path: screenshotPath("cat-game-study-sql-feedback.png") });
await page.mouse.click(800, 510);
await page.waitForTimeout(100);
await page.mouse.click(680, 755);
await page.waitForTimeout(150);
await page.locator(".nyang-code-editor-overlay .cm-content").waitFor({ state: "visible" });
await page.screenshot({ path: screenshotPath("cat-game-study-sql-code.png") });
await page.mouse.click(295, 182);
await page.waitForTimeout(100);
await page.screenshot({ path: screenshotPath("cat-game-study-sql-table.png") });
await page.mouse.click(65, 55);
await page.waitForTimeout(100);
await page.mouse.click(65, 55);
await page.mouse.click(640, 697);
await page.waitForTimeout(100);
await page.screenshot({ path: screenshotPath("cat-game-study-python.png") });
await page.mouse.click(943, 838);
await page.waitForTimeout(100);
await page.screenshot({ path: screenshotPath("cat-game-study-python-page-2.png") });
await page.mouse.click(657, 838);
await page.waitForTimeout(100);
await page.setViewportSize({ width: 1024, height: 640 });
await page.waitForTimeout(100);
await page.screenshot({ path: screenshotPath("cat-game-study-python-compact.png") });
await page.setViewportSize({ width: 1600, height: 900 });
await page.waitForTimeout(100);
await page.mouse.click(390, 175);
await page.waitForTimeout(100);
await page.screenshot({ path: screenshotPath("cat-game-study-type-select.png") });
await page.mouse.click(390, 265);
await page.mouse.click(800, 175);
await page.waitForTimeout(100);
await page.screenshot({ path: screenshotPath("cat-game-study-concept-select.png") });
await page.mouse.click(800, 265);
await page.mouse.click(1200, 175);
await page.waitForTimeout(100);
await page.screenshot({ path: screenshotPath("cat-game-study-difficulty-select.png") });
await page.mouse.click(1200, 265);
...
const codeEditorRoot = page.locator(".nyang-code-editor-overlay");
await codeEditorRoot.evaluate((element) => {
  element.dataset.smokeInstance = "preserved";
});
await page.screenshot({ path: screenshotPath("cat-game-study-code.png") });
...
await codeEditor.waitFor({ state: "visible" });
if ((await codeEditorRoot.getAttribute("data-smoke-instance")) !== "preserved") {
  throw new Error("code editor instance was recreated after successful grading");
}
await page.mouse.click(305, 783);
await page.waitForTimeout(150);
await page.mouse.click(65, 55);
...
await page.mouse.click(1125, 53);
await page.waitForTimeout(200);
await page.screenshot({ path: screenshotPath("cat-game-shop-owned-shortcut.png") });
await page.mouse.click(63, 60);
await page.waitForTimeout(200);
await page.mouse.click(1530, 811);
await page.waitForTimeout(150);
...
await page.mouse.click(865, 490);
await page.waitForTimeout(200);
await page.mouse.click(60, 55);
await page.waitForTimeout(200);
...
if (parsedState.coins !== 1_093_255) {
  throw new Error(`unexpected coins after attendance, study rewards, purchases, and two draws: ${parsedState.coins}`);
}
