...
7. 하우징에서 격자 기반으로 가구·소품을 배치·이동·회전·삭제하고 벽지·바닥을 적용할 수 있다.
...
| 고양이 수집·긍정적 돌봄·격자 하우징 | 유료 재화, 거래·선물, 기간 한정 뽑기, 하우징 능력치, 복잡한 물리 배치 |
...
| 하우징 | 벽지·바닥, 격자 위치·방향·장식 ID | 개인 공간 렌더링 및 공개 방문 |
